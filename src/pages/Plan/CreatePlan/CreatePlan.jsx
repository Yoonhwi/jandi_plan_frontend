            ...
            <div className={styles.plan_inputs}>
              <div className={styles.plan_columns}>
                <Field label="여행지" isRequire>
                  <div className={styles.place}>
                    <Input type="text" style={{ flex: 1 }} value={destination || ""} readOnly />
                    <Modal>
                      <ModalTrigger>
              ...
              <div className={styles.plan_columns}>
                <Field label="플랜 제목" helperText="ex)오사카 가족여행" isRequire>
                  <Input type="text" style={{ width: "100%" }} {...register("planName")} />
                  {errors.planName && <p className={styles.error}>{errors.planName.message}</p>}
                </Field>
              </div>
              <div className={styles.plan_columns}>
                <Field label="출발일" isRequire>
                  <Input type="date" style={{ width: "100%" }} {...register("arrivalDate")} />
                  {errors.arrivalDate && <p className={styles.error}>{errors.arrivalDate.message}</p>}
                </Field>
              </div>
              <div className={styles.plan_columns}>
                <Field label="도착일" isRequire>
                  <Input type="date" style={{ width: "100%" }} {...register("departureDate")} />
                  {errors.departureDate && <p className={styles.error}>{errors.departureDate.message}</p>}
                </Field>
              </div>
              <div className={styles.plan_columns}>
                <Field label="예산안" isRequire>
                  <Input type="number" style={{ width: "100%" }} {...register("budget")} />
              ...
              <div className={styles.plan_columns}>
                <Field label="친구 추가">
                  <div className={styles.place}>
                    <Input type="text" style={{ flex: 1 }} value={withUser || ""} readOnly />
                    <Modal>
                      <ModalTrigger>
