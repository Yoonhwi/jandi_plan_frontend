      ...
      <div className={styles.content_container}>        
        {destinationItems.map((continent) => (
          <div key={continent.title} className={styles.destination_container}>
            ...
            <div className={styles.sub_title_destination}>
               <div className={styles.sub_sub_title}>{subCategory.subTitle}</div>
              <div key={subCategory.destination} className={styles.destination_box}>      
                {subCategory.data.map((destination) => (
                  ...
                  >
                    <img
                      ...
                      className={`${styles.dest_img} ${selectedDestination === destination.name ? styles.selected_img : ""}`}
                    />
                    {selectedDestination === destination.name ? <BiSolidPlaneAlt className={styles.check_box}/> : null}
